<?php
// Archivo: local/conocer_cert/classes/output/candidate_dashboard_page.php
// Página para mostrar el dashboard del candidato
 ...
 */
class candidate_dashboard_page implements renderable, templatable {
